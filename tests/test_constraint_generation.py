...
def test_constraint_generation_simple_sparse(small_sparse_ranking_dataset, pulp_cbc):
    random.seed(0)
    model = LpModel(
        pulp_cbc,
        use_column_generation=False,
...
def test_constraint_generation_miconic_sparse(miconic_mock_sparse_dataset, pulp_cbc):
    random.seed(0)
    model = LpModel(
        pulp_cbc,
        use_column_generation=False,
